...
class EditSheet
{
    ...
    public function topFormButtons(WP_Post $post)
    {
        if ($post->post_type == SheetModel::POST_TYPE && !empty($_GET['action']) && $_GET['action'] === 'edit') {
            ...
            ?>
            <div class="fdsus-edit-quick-info" role="group" aria-label="Sheet Quick Info">
                <span class="quick-info-item quick-info-id"><strong>Sheet ID: </strong> <code><?php echo (int)$post->ID ?></code></span>
