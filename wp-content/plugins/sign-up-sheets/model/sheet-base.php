...
class SheetBase extends Base
{
     ...
     * @param bool        $tryV20First try geting by the old v2.0 ID first
     */
    ...
    public function setFields(&$post)
    {
        ...
        if (
            (
                ...
                (strtotime($endDate) + 864000) > current_time('timestamp')
                || empty($endDate)
            )
        ) {
    ...
    public function getTasks()
    {
        ...
        return $taskCollection->getBySheetId($this->ID);
    }
