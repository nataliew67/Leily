...
class TaskTable
{
    ...
    public function addRowCell($rowKey, $slug, $value, $class = '', $colspan = 1, $rowspan = 1, $element = 'td')
    {
         ...
         * @since 2.2
         */
        $slug = apply_filters('fdsus_tasktable_task_cell_slug', $slug, $value, $class);
         ...
         * @since 2.2
         */
        $value = apply_filters('fdsus_tasktable_task_cell_value', $value, $slug, $class);
    ...
    public function addHeaderCell($slug, $value, $class = '')
    {
         ...
         * @since 2.2
         */
        $slug = apply_filters('fdsus_tasktable_header_cell_slug', $slug, $value, $class);
